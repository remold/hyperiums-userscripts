...
if (!$('.tabbertab').length) {
  ...
  if (race.human.sum > 0) {
    ...
    race.human.avggrowth = Math.round(race.human.growth / race.human.planets);
  }

  if (race.azterk.sum > 0) {
    race.azterk.avg = Math.round(race.azterk.sum / race.azterk.planets);
    race.azterk.avggrowth = Math.round(race.azterk.growth / race.azterk.planets);
  }

  if (race.xillor.sum > 0) {
    race.xillor.avg = Math.round(race.xillor.sum / race.xillor.planets);
    race.xillor.avggrowth = Math.round(race.xillor.growth / race.xillor.planets);
  }
  ...
  if (race.human.avggrowth === 0) { race.human.avggrowth = " ."; }
  if (race.azterk.avggrowth === 0) { race.azterk.avggrowth = " ."; }
  if (race.xillor.avggrowth === 0) { race.xillor.avggrowth = " ."; }
  ...
  $('body div.tinytext:last')
    .after(
      '<div class="banner" ' +
        ...
        '<tr><td>Average Growth #</td>' +
        '<td class="td_right"><strong class="td_right">' + Math.round(populationGrowth / planets) + '</strong></td>' +
        '<td class="td_right">' + race.human.avggrowth + '</td>' +
        '<td class="td_right">' + race.azterk.avggrowth + '</td>' +
        '<td class="td_right">' + race.xillor.avggrowth + '</td></tr>' +
